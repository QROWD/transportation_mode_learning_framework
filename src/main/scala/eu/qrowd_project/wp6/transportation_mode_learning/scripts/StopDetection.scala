...
import eu.qrowd_project.wp6.transportation_mode_learning.preprocessing.{STDBSCAN, TDBSCAN}
...
class StopDetection(val ceps: Double = 0.5, val eps: Double = 0.1, val minPts: Int = 40) {
  ...
  /**
    * Find stop points given a set of GPS points tagged with a timestamp.
    *
